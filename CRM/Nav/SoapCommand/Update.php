...
/**
 * Class CRM_Nav_SoapCommand_Update
 * Implementation for a Navision SOAP Read Command
 */
class CRM_Nav_SoapCommand_Update extends CRM_Nav_SoapCommand_BaseSoapCommand {

  private $updateParams;
  /**
   * CRM_Nav_SoapCommand_Update constructor.
   *
   * @param $searchParams
   */
  ...
  public function execute(&$soapClient) {
    ...
    $this->result = $soapClient->Update($this->updateParams);
  }
}
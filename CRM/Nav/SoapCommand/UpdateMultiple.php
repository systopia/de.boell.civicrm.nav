...
/**
 * Class CRM_Nav_SoapCommand_UpdateMultiple
 * Implementation for a Navision SOAP Read Command
 */
class CRM_Nav_SoapCommand_UpdateMultiple extends CRM_Nav_SoapCommand_BaseSoapCommand {

  private $updateParams;
  /**
   * CRM_Nav_SoapCommand_UpdateMultiple constructor.
   *
   * @param $searchParams
   */
  ...
  public function execute(&$soapClient) {
    ...
    $this->result = $soapClient->UpdateMultiple($this->updateParams);
  }
}